...
public class AddExpenseActivity extends AppCompatActivity {
    ...
    private void setupSpinner() {
        categoryDao.open();
        categories = categoryDao.getCategoriesByType(Constants.TYPE_EXPENSE);
        categoryDao.close();
    ...
    private void saveNewCategory(String categoryName) {
        ...
        newCategory.setType(Constants.TYPE_EXPENSE);
    ...
    private void saveTransaction() {
        try {
            ...
            if (result != -1) {
                Toast.makeText(this, Constants.SUCCESS_EXPENSE_SAVED, Toast.LENGTH_SHORT).show();
                finish();
            } else {
